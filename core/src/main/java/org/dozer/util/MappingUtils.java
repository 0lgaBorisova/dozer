...
public final class MappingUtils {
    ...
    public static class MappedParentFieldKey {

        public Object dest;
        public String fieldKey;
        public String fieldName;
        private static ThreadLocal<MappedParentFieldKey> cache = new ThreadLocal<MappedParentFieldKey>() {

            @Override
            protected MappedParentFieldKey initialValue() {
                return new MappedParentFieldKey();
            }
        };

        private MappedParentFieldKey() {
        }

        private MappedParentFieldKey(Object dest, String fieldKey, String fieldName) {
            this.dest = dest;
            this.fieldKey = fieldKey;
            this.fieldName = fieldName;
        }

        public static MappedParentFieldKey create(Object dest, FieldMap destFieldMap) {
            return new MappedParentFieldKey(dest, destFieldMap.getDestFieldKey(), destFieldMap.getDestFieldName());
        }

        public static boolean containsIn(Collection<MappedParentFieldKey> in, Object dest, FieldMap destFieldMap) {
            if (in == null || destFieldMap == null) {
                return false;
            }
            MappedParentFieldKey get = cache.get();
            get.dest = dest;
            get.fieldKey = destFieldMap.getDestFieldKey();
            get.fieldName = destFieldMap.getDestFieldName();
            boolean result = in.contains(get);
            get.dest = null;
            get.fieldKey = null;
            get.fieldName = null;
            return result;
        ...
        public int hashCode() {
            int hash = 7;
            hash = 53 * hash + System.identityHashCode(this.dest);
            hash = 53 * hash + (this.fieldKey != null ? this.fieldKey.hashCode() : 0);
        ...
        public boolean equals(Object obj) {
            ...
            final MappedParentFieldKey other = (MappedParentFieldKey) obj;
            ...
            if (this.dest != other.dest && (this.dest == null || !(this.dest == other.dest))) { // == compare by reference
                return false;
            }
            return true;
        }
     ...
     * and {@code srcFieldClass} is enum; otherwise return {@code false}.
     */
     ...
     * @return {@code true} if and only if current running JRE is 1.5 or above,
     * and both {@code srcFieldClass} and {@code destFieldType} are enum;
